...
export class PortfolioComponent implements OnInit {
  items = [
    ...
    {
      name: "Amesto",
      image: "assets/amesto.jpg",
      platform: "Web",
      link: "https://www.amesto.com/",
    },
    {
      name: "Souq el medical",
      image: "assets/souq-el-medical.webp",
      platform: "Web,Ios,Android",
      link: "https://apps.apple.com/eg/app/souq-al-medical/id1611046527?platform=iphone",
    },
    {
    ...
    {
      name: "Feed me (akalny)",
      image: "assets/akalny.png",
      platform: "Technical Demo",
      link: "https://psycoders.tech/akalny",
    },
  ];
    ...
    switch (this.activeFilter) {
      ...
      case Filter.demo:
        return this.items.filter((item) =>
          item.platform.includes("Technical Demo")
        );
      default:
        return this.items;
    }
